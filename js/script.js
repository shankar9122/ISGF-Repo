...
(function App() {
    ...
    const calendar = `<div class="container calender_container">
        
            
<div class="row">
<div class="col-sm-12 col-12 d-flex">
    <div class="card border-0 mt-3 flex-fill">
...
$(function () {
    function showEvent(eventDate) {
        ...
        if (storedEvents == null) {
            ...
            if (eventsList.length > 0) {
                let eventsLi = '';
                eventsList.forEach(event => $('.events-today').html(eventsLi += `<div class="alert text-light event_item fade show" role="alert">
                    ${event.eventText}
    ...
    function showEventInCaseDelete(eventDate) {
        let storedEvents = JSON.parse(localStorage.getItem('events'));
        if (storedEvents == null) {
            $('.events-today').html('<h5 class="text-center">No events found</h5 class="text-center">');
        } else {
